...
router.get('/', (req, res) => {
    const data = {
        text:
`Jag heter Johnny och bor i den nordväst-skånska lilla staden Ängelholm. Till vardags jobbar jag på prisjämförelse­sajten Prisjakt med att ta fram och analysera data.
